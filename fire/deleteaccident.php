	...
	<ul class="accident-list">
		...
		if(mysqli_num_rows($Accidents) < 1) {
			if(empty($_GET['page'])) {
				...
				$back = $_GET['page'] - 1;
			echo "You have reached the end <br />";
			echo "<a href='deleteaccident.php?page=$back'><b>Previous Page</b></a>";
			...
			echo "<li>
				...
				<a href='deletepost.php? id=$id' type='button'><button><b>Delete<b></button></a> 
			</li><br />";
		...
		$next=$page+1;
		echo "<a href='deleteaccident.php?page=$next'><b>Next Page</b></a>";
		}
