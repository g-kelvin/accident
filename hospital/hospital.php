...
<br>
<textarea name="hospitalReport"rows="6"></textarea>
<button name="submit" type="submit" value="submit"><b> DOCTOR REPORT</b></button>
 ...
 $hospitalReport=$_POST['hospitalReport'];
 $accidentID=$_GET['id'];
 echo "<label style='color:white'>";
  $connection=mysqli_connect('localhost','root','flamigo','accidentsystem');
   //insert doctor's report into the database.
    $qry=mysqli_query($connection,"INSERT INTO hospitalreport (hospitalReport,hospitalID,accidentID) VALUES('$hospitalReport','1','$accidentID')");
   if ($qry) {
