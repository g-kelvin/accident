...
echo "<label style='color:white'>";
       ...
       $qry=mysqli_query($connection,"SELECT id,firstName,lastName, station FROM users where status='confirmed' AND station='firestation'");
       $no = mysqli_num_rows($qry);
       echo "<br><br><br><center><div id='displaypendingadmins'><h3> The number of confirmed admin is $no</h3></div></center>";
      ...
      while ($i=mysqli_fetch_array($qry)) {
      	...
      	echo "<li>$firstName  \t $lastName \t $station <br>
         <a href='disapprove.php?id=$id'><button><b>disapprove<b></button></a>
      	</li><br>  ";
