...
<h4>ACCIDENT REPORTING SYSTEM</h4>
 ...
 <?php 
  ...
  echo"<label style='color:white'>";
       ...
       $qry=mysqli_query($connection,"SELECT id,firstName,lastName, station FROM users where status='pending'");
      ...
      while ($i=mysqli_fetch_array($qry)) {
        ...
        echo "<br><li>$firstName  \t $lastName \t $station <br>
         <a href='approveadmins.php?id=$id'><button><b>confirm<b></button></a>
        </li><br>  ";
